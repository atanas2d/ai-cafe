...
export class MeetingCard {
     ...
     * Render tags/topics
     */
    renderTags(containerClass = 'meeting-card__tags') {
        const { meeting } = this.props;
 ...
 */
export function createMeetingCard(props) {
 ...
 */
export function renderMeetingCards(meetings, container, options = {}) {
    container.innerHTML = '';
...
//# sourceMappingURL=MeetingCard.js.map